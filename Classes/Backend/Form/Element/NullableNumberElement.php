 ...
 */
class NullableNumberElement extends NumberElement
{
    ...
    public function render(): array
    {
        ...
        $nullControlNameEscaped = 'control[active]' . substr($itemName,4);
    ...
    protected function hasNullCheckboxButNoPlaceholder(): bool
    {
        ...
        if (($parameterArray['fieldConf']['config']['nullable'] ?? false)
